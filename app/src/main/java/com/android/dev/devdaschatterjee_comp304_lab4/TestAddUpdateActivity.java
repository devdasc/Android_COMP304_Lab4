...
public class TestAddUpdateActivity extends AppCompatActivity {
    ...
    public TestAddUpdateActivity(){
        db=new DatabaseHandler(this);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_add_update);
