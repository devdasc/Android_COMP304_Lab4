...
public class Test {
    ...
    public String getBPH() {        return BPH;    }
    public void setBPH(String BPH) {        this.BPH = BPH;    }
    public String getLDLCholesterol() {        return LDLCholesterol;    }
    public void setLDLCholesterol(String LDLCholesterol) {        this.LDLCholesterol = LDLCholesterol;    }
    public String getHDLCholesterol() {        return HDLCholesterol;    }
    public void setHDLCholesterol(String HDLCholesterol) {        this.HDLCholesterol = HDLCholesterol;    }
    public String getMCH() {        return MCH;    }
    public void setMCH(String MCH) {        this.MCH = MCH;    }
    public String getESR() {        return ESR;    }
    public void setESR(String ESR) {        this.ESR = ESR;    }
    public String getPlateletCount() {        return PlateletCount;    }
    public void setPlateletCount(String plateletCount) {        PlateletCount = plateletCount;    }
