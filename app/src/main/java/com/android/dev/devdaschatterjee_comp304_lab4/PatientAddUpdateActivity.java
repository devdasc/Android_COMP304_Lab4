...
public class PatientAddUpdateActivity extends AppCompatActivity {
    ...
    public  PatientAddUpdateActivity(){
        db=new DatabaseHandler(this);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_patient_add_update);
        intializeViews();
    ...
    public  void onSubmitClick(View v)
    {
        ...
        try {
            if (firstName.length() == 0) {
                ...
                patient.setDoctorId(d.getDoctorId());
